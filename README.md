...
- [ ] Şifre ve güvenlik sistemi
- [ ] Döviz hesapları
- [ ] Otomatik ödeme talimatları
- [ ] SMS/Email bildirimleri
- [ ] Grafik arayüz (GUI)
- [ ] Rapor ve ekstre çıktıları
- [ ] Kart işlemleri simülasyonu

## 👥 Katkıda Bulunanlar

Bu proje eğitim amaçlı geliştirilmiş bir Java OOP demonstrasyon projesidir.
...
**Not**: Bu sistem gerçek bir banka uygulaması değildir. Sadece eğitim ve öğrenme amaçlıdır.
